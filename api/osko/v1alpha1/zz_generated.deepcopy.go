...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertManagerSecretRef) DeepCopyInto(out *AlertManagerSecretRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlertManagerSecretRef.
func (in *AlertManagerSecretRef) DeepCopy() *AlertManagerSecretRef {
	if in == nil {
		return nil
	}
	out := new(AlertManagerSecretRef)
	in.DeepCopyInto(out)
	return out
}
